...
export default function AuthLayout({
  ...
  return (
    <main className="h-full] flex flex-col lg:flex-row bg-white">
      ...
      <section className="w-full lg:w-1/2 flex items-center rounded-xl justify-center bg-gradient-to-br from-[#017FA5] via-[#6B7280] to-[#00303F] text-white p-4 sm:p-8">
